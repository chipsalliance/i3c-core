...
package i2c_ral_pkg;
  ...
  class i2c_reg_intr_state extends dv_base_reg;
    ...
    rand dv_base_reg_field acq_full;
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      ...
      acq_full.set_original_access("RO");
      unexp_stop =
          (dv_base_reg_field::
  ...
  class i2c_reg_intr_enable extends dv_base_reg;
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      ...
      acq_full.set_original_access("RW");
      unexp_stop =
          (dv_base_reg_field::
           type_id::create("unexp_stop"));
      unexp_stop.configure(
  ...
  class i2c_reg_intr_test extends dv_base_reg;
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      ...
      acq_full.set_original_access("WO");
      unexp_stop =
          (dv_base_reg_field::
           type_id::create("unexp_stop"));
      unexp_stop.configure(
  ...
  class i2c_reg_target_fifo_config extends dv_base_reg;
    ...
    rand dv_base_reg_field txrst_on_cond;
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      ...
      txrst_on_cond =
          (dv_base_reg_field::
           type_id::create("txrst_on_cond"));
      txrst_on_cond.configure(
        .parent(this),
        .size(1),
        .lsb_pos(15),
        .access("RW"),
      ...
      txrst_on_cond.set_original_access("RW");
      acq_thresh =
          (dv_base_reg_field::
  ...
  class i2c_reg_block extends dv_base_reg_block;
    ...
    virtual function void build(uvm_reg_addr_t base_addr,
      ...
      intr_enable.add_hdl_path_slice(
          ...
          11, 1, 0, "BkdrRegPathRtl");
      intr_enable.add_hdl_path_slice(
          "u_reg.u_intr_enable_acq_full.q",
          12, 1, 0, "BkdrRegPathRtl");
      intr_enable.add_hdl_path_slice(
      ...
      target_fifo_config.add_hdl_path_slice(
          ...
          0, 12, 0, "BkdrRegPathRtl");
      target_fifo_config.add_hdl_path_slice(
          "u_reg.u_target_fifo_config_txrst_on_cond.q",
